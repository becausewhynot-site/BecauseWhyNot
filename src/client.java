...
//				misc.println_debug("outStreamSessionKey["+i+"]: 0x"+Integer.toHexString(sessionKey[i]));
	...
	public boolean pickUpItem(int item, int amount, int delete) {
		...
		if (freeSlots() > 0 && poimiY == currentY && poimiX == currentX) {
			...
			for (int i = 0; i < playerItems.length; i++) {
				if ((playerItems[i] - 1) == item && (Item.itemStackable[item] == true || Item.itemIsNote[item] == true)) {
			...
			case 132:
				...
				if (objectID == 1553 || objectID == 1551 || objectID == 1552 || objectID == 1556) {
					if ((objectX == 3253 && objectY == 3266) || (objectX == 3253 && objectY == 3267) || (objectX == 3241 && objectY == 3301) || (objectX == 3241 && objectY == 3302)) {
						...
						face = -3; //South
						GateID = 2;
					} else if ((objectX == 3237 && objectY == 3284) || (objectX == 3238 && objectY == 3284) ||(objectX == 3237 && objectY == 3295) || (objectX == 3238 && objectY == 3295)) {
						face = -2; //East
						GateID = 2;
					}//else = West (standard)
					if (GateID == 1) {
