...
//		} while(i != playerSlotSearchStart);
	...
	public void process() {
		...
		// this has to be seperated from the outgoing part because we have to keep all
		// the player data
		// static, so each client gets exactly the same and not the one clients are
		// ahead in time
		// than the other ones.
		for (int i = 0; i < maxPlayers; i++) {
	...
	private void removePlayer(Player plr) {
		...
		// anything can be done here like unlinking this player structure from any of
